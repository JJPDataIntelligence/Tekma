...
function validar(obj) { // recebe um objeto
	...
	var tam=(s).length; // removendo os caracteres não numericos
	//if (!(tam==11 || tam==14 || tam==0)){ // validando o tamanho
	if (!(tam==11 || tam==14)){ // validando o tamanho
		alert("'"+s+"' Não é um CPF ou um CNPJ válido!" ); // tamanho invalido
		return false;
	}
...
// O algoritimo de validação de CPF é baseado em cálculos
...
// O algoritimo de validação de CNPJ é baseado em cálculos
// para o dígito verificador (os dois últimos)
// Não entrarei em detalhes de como funciona
