...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
			...
			overlay_gallery: true, /* estava true e mostrava as minuaturas dentro da foto................ If set to true, a gallery will overlay the fullscreen image on mouse over */
				...
				switch(_getFileType(pp_images[set_position])){
					case 'image':
						...
						imgPreloader.onerror = function(){
							alert('A imagem não pode ser carregada.');
							$.prettyPhoto.close();
						};
