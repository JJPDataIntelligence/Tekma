...
<?php
	...
	if($idioma=="en") {
		...
		$txt_conceito3="In addition to these competencies, TEKMA offers project management in the areas of aftersales, logistics, quality and processes.";

		$txt_missao="Our mission is to provide solutions to our customers in mobility services in an advanced, accurate and effective way by adding values based on competitiveness, security and sustainability";
		...
		$txt_serv6="Consulting and advisory on products and process concept, including the elaboration of concept notebooks and specifications, in addition to the execution of projects with usual market tools.";
	}
